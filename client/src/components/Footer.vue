<template>
    <footer>
        ...
        <div class="flex justify-center items-start flex-row gap-36 bg-[#2c3238] text-white">
                ...
                <ul class="text-sm font-semibold">
                    <li class="mb-3 hover:text-purple-600">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 inline-block text-primary-400">
                    ...
                    <li class="mb-3 hover:text-purple-600"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            class="w-6 h-6 inline-block text-primary-400">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                        </svg>
                    ...
                    <li class="mb-3 hover:text-purple-600">
                        ...
                        <a href="mailto:imghostcode@gmail.com">imghostcode@gmail.com</a>
                    </li>
                    <li class="mb-3 hover:text-purple-600">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 inline-block text-primary-400">
            ...
            <div class="flex justify-center items-center flex-col">
                ...
                <ul class="text-sm font-semibold">
                    ...
                    <li class="mb-3"><a href="#" class="hover:text-purple-600">Kích hoạt khóa học</a></li>
                    <li class="mb-3"><a href="#" class="hover:text-purple-600">Góc chia sẻ</a></li>
                    <li class="mb-3"><a href="#" class="hover:text-purple-600">Chính sách bảo mật</a></li>
                </ul>
            </div>
            <div class="flex justify-center items-center flex-col">
                ...
                <ul class="text-sm font-semibold">
                    ...
                    <li class="mb-3"><a href="#" class="hover:text-purple-600">Đào tạo doanh nghiệp</a></li>
                    <li class="mb-3"><a href="#" class="hover:text-purple-600">Affiliate</a></li>
                    <li class="mb-3"><a href="#" class="hover:text-purple-600">Agency</a></li>
                    <li class="mb-3"><a href="#" class="hover:text-purple-600">Quay dựng video</a></li>
                    <li class="mb-3"><a href="#" class="hover:text-purple-600">Đào tạo Inhouse</a></li>
                </ul>
            </div>
            <div class="flex justify-center items-center flex-col">
                ...
                <ul class="text-sm flex">
                    ...
                    <li class="mb-3 text-xl"><a href="https://github.com/imghostcode" target="_blank"
                            class="hover:text-purple-600 px-3 py-3"><i class="fa-brands fa-github"></i></a></li>
        ...
        <div class="bg-black flex justify-center items-center">
            <img src="../assets/image/code-mastery.png" alt="code mastery" class="w-28 h-20 my-3">
        </div>
    </footer>
</template>